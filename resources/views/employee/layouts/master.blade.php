...
<head>
    ...
    <link href="{{\App\Helpers\AppHelper::assetPublic('css/admin/style.css')}}" rel="stylesheet">
...
<body class="app header-fixed sidebar-fixed aside-menu-fixed pace-done sidebar-lg-show">
    ...
    {{--Header--}}
    @include('employee.layouts.partials.__header')

    {{--App Body--}}
    <div class="app-body">
        {{--Sidebar--}}
        @include('employee.layouts.partials.__sidebar')
        ...
        {{--Aside Menu--}}
        @include('employee.layouts.partials.__aside_menu')
    </div>
