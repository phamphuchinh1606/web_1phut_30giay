        ...
        <div class="card-header">
            ...
            <nav class="nav nav-pills flex-column flex-sm-row multi-collapse collapse" id="multiCollapseExample1">
                @foreach($infoDays as $day)
                    ...
                    @else
                        <a class="flex-sm-fill text-sm-center nav-link" href="{{route('input_daily',['date' => $day->date_str])}}">
                            {{$day->date_str}} <span style="color: red">({{$day->week_day}})</span>
                        </a>
                    @endif
                @endforeach
...
@section('body.js')
    ...
    <script>
        InputDailyAPI.UpdateInputPriceDailyUrl = '/input-daily/update-daily.js';
        InputDailyAPI.UpdateInputDailyUrl = '/input-daily/update-daily.js';
        InputDailyAPI.UpdateSaleDailyUrl = '/input-daily/update-sale.js';
        InputDailyAPI.UpdateBillDailyUrl = '/input-daily/update-bill.js';
        InputDailyAPI.UpdateEmployeeDailyUrl = '/input-daily/update-employee.js';
