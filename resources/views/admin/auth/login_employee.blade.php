...
<body class="app flex-row align-items-center" style="background-image: url({{ \App\Helpers\AppHelper::assetPublic('images/background_login.jpg') }})">
<div class="container">
