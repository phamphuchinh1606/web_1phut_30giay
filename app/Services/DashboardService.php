...
class DashboardService extends BaseService {
    ...
    public function monthDashboard($branchId, $date){
        ...
        $dashboard->sum_check_in_1p30s_amount = $this->orderCheckInRepository->getTotalAmountByDate($branchId,$date, OrderCheckIn::CHECK_IN_TYPE);
        $dashboard->sum_check_in_rock_amount = $this->orderCheckInRepository->getTotalAmountByDate($branchId,$date, OrderCheckIn::MOVE_IN_TYPE);
